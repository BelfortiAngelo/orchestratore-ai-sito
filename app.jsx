  ...
  return (
    <nav className={"nav" + (scrolled ? " nav-scrolled" : "")}>
      ...
      <div className="nav-right">
        ...
        <a className="nav-cta" href="https://www.linkedin.com/in/angelobelforti" target="_blank" rel="noreferrer noopener">
    ...
    <footer className="footer">
      <div className="footer-row">
        ...
        <div className="footer-meta">
          ...
          <a href="https://www.linkedin.com/in/angelobelforti" target="_blank" rel="noreferrer noopener">LinkedIn</a>
          <span className="footer-sep" />
